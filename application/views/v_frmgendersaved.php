	...
	<div class="jumbotron">
		<form action="<?=site_url(" c_gender/save4add");?>" method="post">
			<div class="row">
				...
				<div class="col-sm-10">
					<h3>Hasil Proses Entri Kode Gender</h3><br>
				</div>
			</div>
			<div class="form-group row">
				<label for="rgender_kode" class="col-sm-2 col-form-label">Kode Gender</label>
				<div class="col-sm-3">
					<input type="text" name="rgender_kode" id="rgender_kode" value="<?=$rgender_kode;?>" readonly
            ...
            <div class="form-group row">
				...
				<div class="col-sm-3">
					<input type="text" name="rgender_nama" id="rgender_nama" value="<?=$rgender_nama;?>" readonly
						class="form-control-plaintext">
				</div>
            </div>
            <div class="form-group row">
				...
				<div class="col-sm-4">
                    <?=$saveresult;?><br>
                    <?=anchor("c_gender/form2add", "Klik Untuk tambah Data"); ?>
				</div>
			</div>
		</form>
	</div>

	...
	<div class="jumbotron">
		<form action="<?=site_url("c_edulevel/save4add");?>" role="form" class="form-horizontal" method="POST">
            ...
            <div class="form-group row">
				...
				<div class="col-sm-3">
                    <button class="btn btn-primary" value="Tambah" name="btn_submit" type="submit">Simpan</button>
                    
                    <button class="btn btn-warning" value="Reset" name="btn_reset" type="reset"> Reset</button>
				</div>
			</div>
		</form>
	</div>
